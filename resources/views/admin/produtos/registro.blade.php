...
@section('content')
    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    {!! Form::cSelect('categoria', 'Categoria', (new \App\Model\Categorias)->getData()) !!}
                </div>
                <div class="col-md-6">
                    {!! Form::cText('nome', 'Nome') !!}
                </div>
                <div class="col-md-3">
                    {!! Form::cText('preco', 'Preço',null, ['class'=>'form-control money2']) !!}
                </div>
                <div class="col-md-3">
                    {!! Form::cText('estoque', 'Estoque') !!}
                </div>
                <div class="col-md-3">
                    {!! Form::cSelect('status', 'Status', \App\Http\Helpers\DataHelpers::getAtivos()) !!}
                </div>
                <div class="col-md-12">
                    {!! Form::cTextarea('descricao', 'Descrição') !!}
                </div>
            </div>
